...
exports.execute = async function (msg, command, args, client, D, perm, color) {
    ...
    .addField('Kunyomi example: ' , result.kunyomiExamples[0].example +" Example\n"+result.kunyomiExamples[0].reading +" Reading\n"+result.kunyomiExamples[0].meaning +" Meaning" )
    .addField('Onyomi: ' , result.onyomi.join(","))
    .addField('Onyomi example: ' , result.onyomiExamples[0].example +" Example\n"+result.onyomiExamples[0].reading +" Reading\n"+result.onyomiExamples[0].meaning +" Meaning" )
    .addField('Radical: ' , `${result.radical.symbol} Symbol \n ${result.radical.forms} Forms \n ${result.radical.meaning}`)
